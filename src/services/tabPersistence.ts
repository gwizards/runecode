...
const STORAGE_KEY = 'runecode_tabs_v2';
const ACTIVE_TAB_KEY = 'runecode_active_tab_v2';
const PERSISTENCE_ENABLED_KEY = 'runecode_tab_persistence_enabled';
  ...
  static migrateFromOldFormat(): void {
    try {
      ...
      if (oldData && !localStorage.getItem(STORAGE_KEY)) {
        ...
        console.debug('Migrated tab data from old format');
      }
    } catch (error) {

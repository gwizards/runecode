/// Checkpoint diff, fork, timeline, settings, cleanup, and session-tracking handlers.
///
/// Split from `checkpoints.rs` to stay within the 500-line file budget.
...
use super::checkpoints::{extract_checkpoint_params, guard_project_path, validate_session_id};
